...
def objectivexgb(trial):
    ...
    # X_train = main_u.X_train_sc
    X_train = np.loadtxt('/home/silver/PycharmProjects/AAEDRL/AAE/best.txt')[:82716]
    y_train = classifier.y_train
    X_test = classifier.X_test_sc
    y_test = classifier.y_test.to_numpy()
